                ...
                <main className="pv-main">
                    ...
                    <div className="tabella-mezzi">
                        <div className="intestazione-tabella">
                            ...
                            <div className="intestazione-col w-72">
                                Data creazione
                            </div>
                            <div className="intestazione-col w-80">
                                Tipologia
                            </div>
                        ...
                        {sample.map((a, i) => (
                            <div
                                className={`righe-tabella${i === sample.length - 1 ? " righe-tabella-last" : ""}`}
                                key={a.id}
                            >
                                <div className="righe-frame flex">
                                    <div className="nome-campo w-72">
                                        {a.name}
                                    </div>
                                    <div className="nome-campo w-72">
                                        {a.created}
                                    </div>
                                    <div className="nome-campo w-80">
                                        {a.type}
                                    </div>
                                    <div className="nome-campo w-44">
                                        {a.threshold}
                                    </div>
                                    <div className="nome-campo w-56">
                                        {a.state}
                                    </div>
                                </div>
